...
colors = ["cyan", "teal", "green", "blue", "red", "yellow", "orange", "purple", "grey"]
codes = [
    "\uf001", "\uf002", "\uf003", "\uf004", "\uf005", "\uf006", "\uf007",
    "\uf008", "\uf009", "\uf00a", "\uf00b", "\uf00c", "\uf00d", "\uf00e",
    "\uf010", "\uf011", "\uf012", "\uf013", "\uf014", "\uf015", "\uf016",
...
def update(num_iterations=sys.maxsize):
    global device
    global regulator
    global codes
    for thing in infinite_shuffle(codes):
        code = thing
        break
    with regulator:
        num_iterations -= 1
        ...
        with canvas(device) as draw:
            ...
            draw.text((left, top), text=code, font=font, fill=colors[0])
